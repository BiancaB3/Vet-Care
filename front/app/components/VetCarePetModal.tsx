...
import type { PetDraft } from '../context/DraftContext';
      ...
      <form onSubmit={onSubmit} className="p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" value={petForm.breed} onChange={(e) => onPetFormChange({ ...petForm, breed: e.target.value })} placeholder="Raça" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:border-primary font-medium" />
          </div>
          <div>
