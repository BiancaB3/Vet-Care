            ...
            <div className="bg-white rounded-3xl w-full max-w-lg max-h-[90vh] overflow-y-auto border border-slate-200 shadow-2xl">
              ...
              <form onSubmit={handleAddTutor} className="p-6">
                <div className="flex gap-6">
                  ...
                  <div className="flex flex-col items-center justify-center w-full sm:w-56 bg-white rounded-xl shadow p-4">
                    ...
                    <div className="w-full">
                      <input type="file" accept="image/*" className="w-full border border-slate-200 rounded-xl px-3 py-2 mt-1" />
                    </div>
                  </div>
                </div>
              </form>
                ...
                <div className="flex gap-6">
                  ...
                  <div className="flex flex-col items-center justify-center w-full sm:w-56 bg-white rounded-xl shadow p-4">
                    ...
                    <div className="w-32 h-32 rounded-full bg-slate-100 flex items-center justify-center mb-2">
                      ...
                      {petToEdit?.species ? getSpeciesIcon(petToEdit.species) : <Dog className="w-16 h-16 text-primary" />}
                    </div>
                    <div className="w-full">
                      <input type="file" accept="image/*" className="w-full border border-slate-200 rounded-xl px-3 py-2 mt-1" />
                    </div>
